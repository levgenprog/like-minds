						...
						<div class="inner">
							...
							<!-- Section -->
								<section>
									...
									<div class="posts">
										<article>
											<a href="sous.php" class="image"><img src="../main/cat/orig.gif" alt="" /></a>
											<h3>Здоровье и спорт</h3>
											<ul class="actions">
												<li><a href="sous.php" class="button">Перейти</a></li>
											</ul>
										</article>
										<article>
											<a href="ЦЗД.html" class="image"><img src="images/6.jpg" alt="" /></a>
											<h3>Интеллектуальное развитие</h3>
											<ul class="actions">
                                        ...
                                        <article>
											...
											<h3>Развитие любовных отношений</h3>
											<ul class="actions">
										...
										<article>
											<a href="ABC.html" class="image"><img src="images/7.jpg" alt="" /></a>
											<h3>Развитие родительских отношений</h3>
											<ul class="actions">
												<li><a href="ABC.html" class="button">Читать</a></li>
											</ul>
										</article>
