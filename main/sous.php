						...
						<div class="inner">
							...
							<!-- Section -->
								<section>
									...
									<div class="posts">
										<article>
											<a href="ppar.php" class="image"><img src="cat/beg.gif" alt="" /></a>
											<h3>Беговая тренировка</h3>
											<ul class="actions">
												<li><a href="ppar.php" class="button">Перейти</a></li>
											</ul>
										</article>
										<article>
											<a href="ЦЗД.html" class="image"><img src="images/6.jpg" alt="" /></a>
											<h3>Фитнесс в закрытом помещении</h3>
											<ul class="actions">
										...
										<article>
											...
											<h3>Улучшение навыков в спортивной дисциплине</h3>
											<ul class="actions">
										...
										<article>
											...
											<h3>Поддержание здоровой диеты</h3>
											<ul class="actions">
